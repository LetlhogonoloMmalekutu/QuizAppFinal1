...
import com.example.ekasilabalexcdtb.quizappfinal.Questions.WhoAmiQ;
...
public class WhoAmI extends AppCompatActivity {
    ...
    private WhoAmiQ mWhoAmiQ = new WhoAmiQ();
    private  String mAnswer;
    private  int mScore = 0;
    private int mQuestionsLenght= mWhoAmiQ.mQuestion.length;
    ...
    private  void updateQuestion(int num){
        question.setText(mWhoAmiQ.getQuestion(num));
        answer1.setText(mWhoAmiQ.getChoice1(num));
        answer2.setText(mWhoAmiQ.getChoice2(num));
        answer3.setText(mWhoAmiQ.getChoice3(num));
        answer4.setText(mWhoAmiQ.getChoice4(num));

        mAnswer= mWhoAmiQ.getCorrectAnwer(num);
    }
    private void gameOver() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(WhoAmI.this);
